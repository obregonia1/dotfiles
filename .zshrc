...
# docker #
##########
alias dru="docker compose run --rm app bundle exec rubocop"
alias dp="docker ps"
alias bdu="bin/docker up"
alias drs="docker compose run --rm app bundle exec rspec"
alias ds="bin/docker exec site"
alias drc="docker compose run --rm app bin/rails c"
alias dbe="bin/docker exec site bundle exec"
alias da="docker attach"
alias de="docker compose run --rm app"
